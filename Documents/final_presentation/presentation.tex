...
\begin{frame}{Steganalysis}
  \only<1>{
    ...
    \only<2>{
      \begin{figure}
        \includegraphics[height=0.5\textheight]{./img/legend.png}
        \includegraphics[height=0.5\textheight]{./img/val_PE.png}
      ...
      \only<3>{
        \begin{figure}
          \includegraphics[width=0.45\textwidth]{./img/cover.png}
